...
CREATE SEQUENCE IF NOT EXISTS public.rao_lineitems_item_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.rao_receivedat_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.rao_summary_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.rao_supplier_details_id_seq START 1;


CREATE SEQUENCE IF NOT EXISTS public.invoice_summary_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_supplier_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.mrn_buyer_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.mrn_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.mrn_lineitems_item_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.mrn_summary_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.mrn_supplier_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.pdf_conversion_hypotus_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.po_billto_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.po_details_po_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.po_line_items_item_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.po_shipping_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.po_summary_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.po_supplier_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.po_terms_conditions_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.purchase_order_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.rao_details_rao_id_seq START 1;


CREATE SEQUENCE IF NOT EXISTS public.hypotus_bbox_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.image_classification_hypotus_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.image_duplicates_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_asset_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_bank_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_buyer_details_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_check_list_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_details_invoice_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_lineitems_item_id_seq START 1;
CREATE SEQUENCE IF NOT EXISTS public.invoice_shipping_details_id_seq START 1;

-- The rest of the schema (as uploaded by the user)
-- We'll append it here after the sequences
